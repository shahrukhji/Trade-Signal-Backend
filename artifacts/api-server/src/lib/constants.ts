...
/** NIFTY Midcap 100 representative stocks — tokens verified from Angel One scrip master */
export const MIDCAP_STOCKS = [
  { symbol: "PERSISTENT-EQ",  token: "18365", name: "Persistent Systems" },
  { symbol: "PIIND-EQ",       token: "24184", name: "PI Industries" },
  ...
  { symbol: "UNIONBANK-EQ",   token: "10753", name: "Union Bank of India" },
  { symbol: "FEDERALBNK-EQ",  token: "1023",  name: "Federal Bank" },
  { symbol: "YESBANK-EQ",     token: "11915", name: "Yes Bank" },
  { symbol: "VOLTAS-EQ",      token: "3718",  name: "Voltas" },
  { symbol: "HAVELLS-EQ",     token: "9819",  name: "Havells India" },
  { symbol: "GODREJCP-EQ",    token: "10099", name: "Godrej Consumer Products" },
  { symbol: "COLPAL-EQ",      token: "15141", name: "Colgate Palmolive" },
  { symbol: "IDFCFIRSTB-EQ",  token: "11184", name: "IDFC First Bank" },
  { symbol: "TORNTPHARM-EQ",  token: "3518",  name: "Torrent Pharmaceuticals" },
  { symbol: "INDUSTOWER-EQ",  token: "29135", name: "Indus Towers" },
  { symbol: "POLYCAB-EQ",     token: "9590",  name: "Polycab India" },
  { symbol: "EXIDEIND-EQ",    token: "676",   name: "Exide Industries" },
  { symbol: "LUPIN-EQ",       token: "10440", name: "Lupin" },
  { symbol: "ABCAPITAL-EQ",   token: "21614", name: "Aditya Birla Capital" },
];

/** Popular Small & Mid-Small Cap stocks — tokens verified from Angel One scrip master */
export const SMALLCAP_STOCKS = [
  { symbol: "IRFC-EQ",        token: "2029",  name: "IRFC" },
  { symbol: "NHPC-EQ",        token: "17400", name: "NHPC" },
  { symbol: "CDSL-EQ",        token: "21174", name: "CDSL" },
  { symbol: "TANLA-EQ",       token: "13976", name: "Tanla Platforms" },
  { symbol: "INDIANB-EQ",     token: "14309", name: "Indian Bank" },
  { symbol: "TATACHEM-EQ",    token: "3405",  name: "Tata Chemicals" },
  { symbol: "CONCOR-EQ",      token: "4749",  name: "CONCOR" },
  { symbol: "NLCINDIA-EQ",    token: "8585",  name: "NLC India" },
  { symbol: "RVNL-EQ",        token: "9552",  name: "RVNL" },
  { symbol: "RAILTEL-EQ",     token: "2431",  name: "RailTel Corporation" },
  { symbol: "HUDCO-EQ",       token: "20825", name: "HUDCO" },
  { symbol: "FINEORG-EQ",     token: "3744",  name: "Fine Organics" },
  { symbol: "CAMS-EQ",        token: "342",   name: "CAMS" },
  { symbol: "MAPMYINDIA-EQ",  token: "7227",  name: "MapMyIndia" },
  { symbol: "EASEMYTRIP-EQ",  token: "2792",  name: "EaseMyTrip" },
  { symbol: "IDBI-EQ",        token: "1476",  name: "IDBI Bank" },
  { symbol: "RECLTD-EQ",      token: "15355", name: "REC Ltd" },
  { symbol: "PFC-EQ",         token: "14299", name: "Power Finance Corporation" },
  { symbol: "SJVN-EQ",        token: "18883", name: "SJVN" },
